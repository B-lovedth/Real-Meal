...
const VeggieVeiw = () => {
  ...
  const getVeggieVeiw = async () => {
    const AbortCont = new AbortController();
    fetch(
      `https://api.spoonacular.com/recipes/random?apiKey=${process.env.REACT_APP_API_KEY}&number=${itemNum}&tags=vegan`,
